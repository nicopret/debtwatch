...
export const debtInterestExplainedArticle: ArticleData = {
  ...
  description:
    "Debt interest is the annual cost of servicing the government's debt—and it is now rising sharply. As market yields climb and inflation-linked bonds reprice, a growing share of the UK's debt is being refinanced at significantly higher rates, pushing up the cost of borrowing far faster than most people realise.",
  keyTakeaway:
    "Debt interest is not about how much the government owes—it is about what it costs to carry that debt each year. And as yields rise, that cost can increase rapidly, adding billions to the annual bill without any new spending.",
