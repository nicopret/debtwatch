...
export const debtInterestExplainedArticle: ArticleData = {
  ...
  sections: [
    ...
    {
      id: "extra-interest",
      heading: "This Year We Will Add Â£10 billion of Interest",
      body: [
        "Each year, the UK doesn't just add new debtâ€”it also resets the cost of existing debt as it is rolled over. With roughly <b>Â£200 - Â£250 billion of gilts maturing annually</b>, a large portion of the debt stock is constantly being refinanced at current market rates. When interest rates were closer to 2 - 3%, this process was relatively manageable. But with yields now closer to 5%, the cost of refinancing has risen sharply, adding tens of billions of pounds in additional interest over time.",
        "To put this into perspective, refinancing Â£250 billion of debt at 5% implies an annual interest cost of around Â£12 - Â£13 billion on that portion alone. If those same bonds had been refinanced at a lower rateâ€”say 2.6%, similar to countries like Germanyâ€”the cost would be closer to Â£6 - Â£7 billion. That gap, of roughly Â£5 - Â£6 billion per year, is the additional burden created by higher borrowing costs on just one year's rollover. As this process repeats year after year, more of the total debt stock is exposed to these higher rates, steadily pushing up the overall interest bill.",
        "On top of refinancing, the government is also adding new borrowing through the deficitâ€”currently around <b>Â£130 billion per year</b> â€” which itself carries interest costs from the outset. Combined with an existing annual interest bill already approaching Â£100 billion, this creates a compounding effect: higher rates increase the cost of both old and new debt, while continued borrowing expands the base those rates apply to. The result is a growing structural pressure on public finances, where rising interest costs are driven not just by how much the government borrows, but by the price it pays to borrow it."
      ]
    },
    {
      id: "rethinking-debt",
      ...
      body: [
        "The UK's debt position is not just a question of numbers â€” it reflects deeper structural issues in how the economy is organised. A service-led model, while important, has not delivered the level of <b>productivity, resilience, or growth needed</b> to sustain rising levels of borrowing. To change course, the UK must place greater emphasis on <b>reindustrialisation</b>, energy security, and productive investment. This includes creating the conditions for long-term growth through competitive policy, while also recognising that energy costs and industrial capacity play a central role in economic strength.",
        "At the same time, the government must take a more disciplined approach to public finances. That means looking carefully at how <b>money is spent</b>, including the structure of the public sector and the long-term cost of commitments such as pensions. Reforming how pensions are administered â€” potentially shifting gradually toward more privately funded elements â€” could reduce long-term fiscal pressure, although such changes must be managed carefully over time. Alongside this, reducing reliance on borrowing and beginning to <b>pay down debt rather than continuously rolling it over</b> would mark a fundamental shift toward more sustainable finances.",
